...
int restore_pages(size_t page, size_t num_pages)
{
    ...
    return protect_pages(page, num_pages, PROT_READ | PROT_WRITE | PROT_EXEC)
        && protect_pages(page, num_pages, PROT_READ | PROT_EXEC)
        && protect_pages(page, num_pages, PROT_READ | PROT_WRITE)
        && protect_pages(page, num_pages, PROT_READ);
}
